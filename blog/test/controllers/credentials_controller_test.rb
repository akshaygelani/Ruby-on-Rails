...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post credentials_url, params: { credential: { password: @credential.password, uid: @credential.uid, username: @credential.username } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { password: @credential.password, uid: @credential.uid, username: @credential.username } }
